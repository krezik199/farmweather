        ...
        <div style={{ marginTop:14 }}>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginBottom:12 }}>
            ...
            <div style={{ background:"#0f1f35", borderRadius:10, padding:"10px 12px", border:"1px solid #1e3a5f", textAlign:"center" }}>
              ...
              <div style={{ fontSize:10, color:"#475569" }}>{planted.getFullYear()}</div>
            </div>
          </div>
...
export default function GDDTab({ farms }) {
  ...
  const [form, setForm]                 = useState({ name:"", farmId:"", crop:"onion", variety:"Legend", plantingDate:"" });
  ...
  return (
    <div style={{ padding:"0 16px", paddingBottom:80 }}>
      ...
      {loading && <div style={{ display:"flex", justifyContent:"center", padding:"40px 0" }}><div style={S.spinner}/></div>}
      ...
      {showAdd && (
        <div style={S.modal} onClick={() => setShowAdd(false)}>
          <div style={S.modalBox} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ fontSize:12, color:"#475569", marginBottom:16 }}>Fields are shared — all users will see this field.</div>
            ...
            <div style={{ fontSize:11, color:"#334155", marginBottom:14 }}>
              GDD will be calculated from this date using historical weather data at the selected farm.
            </div>
